...
class CreateOrderDetails(PayloadBaseModel):
    ...
    redirect_url: Optional[str] = Field(alias='hppRedirectUrl', default=env.KAPITAL_REDIRECT_URL)
    order_type: Optional[str] = Field(alias='typeRid', default='Order_SMS')
    capture_purposes: Optional[List[str]] = Field(alias='hppCofCapturePurposes', default=['Cit'])
